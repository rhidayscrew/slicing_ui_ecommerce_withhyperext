        ...
        child: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment
                .start, // add crossAxisAlignment start  agar Products di samping kiri
            children: [
              // add sercfomr1s
              Container(
              ...
              ListView.builder(
                ...
                shrinkWrap:
                    true, // add ini klo pake SingleChildScrollView agar tidak bentrok dan error
                itemBuilder: (BuildContext context, int index) {
                  return Card(
                    // add item_product_row dari snipett, ganti nya didisini
                    child: Padding(
